...
CREATE TABLE `content`  (
  ...
  `SoundStatus` int NULL DEFAULT 0 COMMENT '音频播放状态：0未播放，1播放中，2已播放',
...
-- ----------------------------
-- Records of history_session
-- ----------------------------
INSERT INTO `history_session` VALUES (105, 4, '思特里克兰德', '月亮和六便士', '如果天空是黑暗的，那就摸黑生存；如果发出声音是危险的，那就保持沉默；如果自觉无力发光的，那就蜷伏于墙角。但不要习惯了黑暗就为黑暗辩护；不要为自己的苟且而得意；不要嘲讽那些比自己更勇敢热情的人们。我们可以卑微如尘土，不可扭曲如蛆虫。', '1320245621X', '英国 伦敦', 'https://s1.ax1x.com/2023/01/09/pSeEDfA.jpg', 'nhzbz5@163.com', 1);
INSERT INTO `history_session` VALUES (106, 5, '何塞·阿尔卡蒂奥·布恩迪亚', '百年孤独', '生命中曾经有过的所有灿烂，终究都需要用寂寞来偿还。', '1320245621X', '加勒比海 马孔多,', 'https://s1.ax1x.com/2023/01/10/pSe56nU.jpg', 'rtzfr1@163.com', 1);
INSERT INTO `history_session` VALUES (107, 7, '叶藏', '人间失格', '如果有人在背后议论你，那只能说明你活的比他们精彩许多。不要惧怕那些路上的荆棘，不要在意那些冷眼与嘲讽，哪怕做一只小小的萤火虫，也有属于自己的光芒，这份光芒真实而美丽。因为你的光芒耀眼才会有旁人的质疑与伤害，因为你的光芒不同才会有他人的阻拦和否定，这一切的一切都是因为你拥有他们所没有的光芒。冷嘲热讽是对你的赞赏，闲言碎语是为你的精彩鼓掌。', '1320245621X', '日本', 'https://s1.ax1x.com/2023/01/10/pSe5sXT.jpg', 'hphjt9@163.com', 1);
...
CREATE TABLE `user`  (
  ...
  `PersonalitySign` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '个性签名',
  `Mobile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '手机号',
  `OnlineState` tinyint NULL DEFAULT NULL COMMENT '在线状态',
  `Region` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '地区',
  `Avatar` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '头像',
